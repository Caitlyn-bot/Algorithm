...
public class Code01_Comparator {
     ...
     * 返回0的时候，认为无所谓谁放前面
     */
    public static class IdPromotionAgeDemotion implements Comparator<Student>{
        /**
...
//			return 0;
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(students, new IdPromotionAgeDemotion());
        ...
        studentList.sort(new IdPromotionAgeDemotion());
